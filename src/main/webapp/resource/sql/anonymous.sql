...
insert  into `an_anonym`(`anonymId`,`nickName`,`userName`,`password`,`headerImg`,`phone`,`isLock`,`deviceId`,`lockReason`,`delFlag`,`createTime`,`updateTime`) values ('e4295540-c3e7-44f2-bbae-2ee6d30d5a13','张三','18320172397',NULL,'','18320172397',1,'864664034884823',NULL,1,'2018-01-20 10:34:19','2018-01-20 10:34:19');
...
insert  into `an_card`(`cardId`,`cardContent`,`cardImg`,`isLock`,`lockReason`,`createTime`,`updateTime`,`delFlag`,`anonymId`) values ('2fe0a9c4-cde7-4084-aac1-22cdf6214a3c','哈哈哈哈哈哈哈?????你摸摸女号绿卡饿了紧张????','http://192.168.16.128:9999/group1/M00/00/00/wKgQgFpjL-mAXiIeAACOI1ye29A5910116',1,NULL,'2018-01-20 12:02:56','2018-01-20 12:02:56',1,'e4295540-c3e7-44f2-bbae-2ee6d30d5a13');
...
CREATE TABLE `an_cardcollection` (
  `cardCollectiionId` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '主键',
  `createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  `anonymId` varchar(100) CHARACTER SET utf8 DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `an_cardcomment` (
  ...
  `cardCommentContent` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '评论内容',
...
CREATE TABLE `an_story` (
  ...
  `storyTitle` varchar(200) CHARACTER SET utf8 DEFAULT NULL COMMENT '标题',
  `storyContent` longtext CHARACTER SET utf8 COMMENT '内容',
